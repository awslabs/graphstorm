...
def main(args):
    ...
    th.save(th.tensor(emb0_0), os.path.join(emb_output_ntype0, f"emb.part{pad_file_index(0)}.bin"))
    th.save(th.tensor(nid0_new_0), os.path.join(emb_output_ntype0, f"nids.part{pad_file_index(0)}.bin"))

    th.save(th.tensor(emb1_0), os.path.join(emb_output_ntype1, f"emb.part{pad_file_index(0)}.bin"))
    th.save(th.tensor(nid1_new_0), os.path.join(emb_output_ntype1, f"nids.part{pad_file_index(0)}.bin"))

    th.save(th.tensor(emb0_1), os.path.join(emb_output_ntype0, f"emb.part{pad_file_index(1)}.bin"))
    th.save(th.tensor(nid0_new_1), os.path.join(emb_output_ntype0, f"nids.part{pad_file_index(1)}.bin"))

    th.save(th.tensor(emb1_1), os.path.join(emb_output_ntype1, f"emb.part{pad_file_index(1)}.bin"))
    th.save(th.tensor(nid1_new_1), os.path.join(emb_output_ntype1, f"nids.part{pad_file_index(1)}.bin"))
