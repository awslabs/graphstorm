...
python3 $DGL_HOME/tools/launch.py --workspace $GS_HOME/training_scripts/gsgnn_lp --num_trainers $NUM_TRAINERS --num_servers 1 --num_samplers 0 --part_config /data/movielen_no_edata_100k_train_val_1p_4t/movie-lens-100k.json --ip_config ip_list.txt --ssh_port 2222 "python3 gsgnn_lp.py --cf ml_lp.yaml --num-gpus $NUM_TRAINERS --part-config /data/movielen_no_edata_100k_train_val_1p_4t/movie-lens-100k.json --n-epochs 1 --evaluation-frequency 300"
