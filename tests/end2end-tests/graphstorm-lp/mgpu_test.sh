...
cnt=$(grep "| Test hit@1" /tmp/train_log.txt | wc -l)
...
bst_cnt=$(grep "Best Validation hit@1" /tmp/train_log.txt | wc -l)
if test $bst_cnt -lt 1
then
...
cnt=$(grep "Validation hit@1" /tmp/train_log.txt | wc -l)
if test $cnt -lt $bst_cnt
then
...
bst_cnt=$(grep "Best Test hit@3" /tmp/train_log.txt | wc -l)
if test $bst_cnt -lt 1
then
...
cnt=$(grep "| Test hit@3" /tmp/train_log.txt | wc -l)
if test $cnt -lt $bst_cnt
then
...
bst_cnt=$(grep "Best Validation hit@3" /tmp/train_log.txt | wc -l)
if test $bst_cnt -lt 1
then
...
cnt=$(grep "Validation hit@3" /tmp/train_log.txt | wc -l)
if test $cnt -lt $bst_cnt
then
...
bst_cnt=$(grep "Best Test hit@10" /tmp/train_log.txt | wc -l)
if test $bst_cnt -lt 1
then
...
cnt=$(grep "| Test hit@10" /tmp/train_log.txt | wc -l)
if test $cnt -lt $bst_cnt
then
...
bst_cnt=$(grep "Best Validation hit@10" /tmp/train_log.txt | wc -l)
if test $bst_cnt -lt 1
then
...
cnt=$(grep "Validation hit@10" /tmp/train_log.txt | wc -l)
if test $cnt -lt $bst_cnt
then
