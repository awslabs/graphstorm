...
python3 $DGL_HOME/tools/launch.py --workspace $GS_HOME/training_scripts/m5gnn_ec/ --num_trainers $NUM_TRAINERS --num_servers 1 --num_samplers 0 --part_config /data/test_ec_1p_4t/test.json --ip_config ip_list.txt --ssh_port 2222 "python3 m5gnn_ec_huggingface.py --cf test_ec.yaml --train-nodes 0 --num-gpus 1 --part-config /data/test_ec_1p_4t/test.json"
...
python3 $DGL_HOME/tools/launch.py --workspace $GS_HOME/training_scripts/m5gnn_ec/ --num_trainers $NUM_TRAINERS --num_servers 1 --num_samplers 0 --part_config /data/test_ec_undirected_1p_4t/test.json --ip_config ip_list.txt --ssh_port 2222 "python3 m5gnn_ec_huggingface.py --cf test_ec.yaml --train-nodes 0 --num-gpus 1 --part-config /data/test_ec_undirected_1p_4t/test.json --exclude-training-targets True --reverse-edge-types-map node,r0,rev-r0,item"
...
python3 $DGL_HOME/tools/launch.py --workspace $GS_HOME/training_scripts/m5gnn_ec/ --num_trainers $NUM_TRAINERS --num_servers 1 --num_samplers 0 --part_config /data/test_ec_nodefeat_1p_4t/test.json --ip_config ip_list.txt --ssh_port 2222 "python3 m5gnn_ec_huggingface.py --cf test_ec.yaml --train-nodes 0 --num-gpus 1 --part-config /data/test_ec_nodefeat_1p_4t/test.json --exclude-training-targets True --reverse-edge-types-map node,r0,rev-r0,item --feat-name embedding"

error_and_exit $?

echo "**************dataset: Test edge classification, RGAT layer: 1, node feat: fixed HF BERT, BERT nodes: movie, inference: mini-batch"
python3 $DGL_HOME/tools/launch.py --workspace $GS_HOME/training_scripts/m5gnn_ec/ --num_trainers $NUM_TRAINERS --num_servers 1 --num_samplers 0 --part_config /data/test_ec_1p_4t/test.json --ip_config ip_list.txt --ssh_port 2222 "python3 m5gnn_ec_huggingface.py --cf test_ec.yaml --model-encoder-type rgat --train-nodes 0 --num-gpus 1 --part-config /data/test_ec_1p_4t/test.json"
