...
and GraphStorm Distributed Data Partitioning (GPartition). GSProcessing will preprocess the raw data into structured
datasets, and GPartition will process these structured datasets to create multiple partitions in
...
* **RUN GPartition**: Use GPartition to partition the processed data into graph files suitable for distributed training.
