...
def wrap_model_artifacts(path_to_model, path_to_yaml, path_to_json, path_to_entry,
    ...
    path_to_yaml: str
        The path of the YAML file (training/inference hyperparameter configuration file) generated by GraphStorm during model training.
    path_to_json: str
        The path of JSON file (graph schema and processing configuration file) generated by GraphStorm gconstruct or GSProcessing.
    path_to_entry: str
