...
RUNTIME_TRAIN_CONFIG_FILENAME = "GRAPHSTORM_RUNTIME_UPDATED_TRAINING_CONFIG.yaml"
GS_RUNTIME_UPDATED_TRAINING_CONFIG_FILENAME = "GRAPHSTORM_RUNTIME_UPDATED_TRAINING_CONFIG.yaml"

# Filename for output graph data configuration, updated with transformation output
RUNTIME_GCONSTRUCT_FILENAME = "data_transform_new.json"
