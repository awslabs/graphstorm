...
if __name__ == '__main__':
    ...
    parser.add_argument("--user_age_as_label", type=lambda x: (str(x).lower() in ['true', '1']), default=False)
    parser.add_argument("--user_text", type=lambda x: (str(x).lower() in ['true', '1']), default=False,
