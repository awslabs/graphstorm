...
def parse_node_data(in_file, feat_ops, label_ops, node_id_col, read_file, ext_mem=None):
    ...
    if feat_ops is not None:
        feat_data, feat_dim_list = process_features(data, feat_ops, ext_mem)
    else:
        feat_data, feat_dim_list = {}, []
    ...
    return (node_ids, feat_data, feat_dim_list)
...
def parse_edge_data(in_file, feat_ops, label_ops, node_id_map, read_file,
    ...
    return (src_ids, dst_ids, feat_data, feat_dim_list)
