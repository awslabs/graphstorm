...
def edge_mini_batch_gnn_predict(model, loader, return_label=False, return_proba=False):
...
def edge_mini_batch_predict(model, emb, loader, return_label=False, return_proba=False):
