...
class GSgnnEdgeModel(GSgnnBase):
    ...
    def inference(self, val_test_nodes, val_src_dst_pairs, test_src_dst_pairs, val_labels, test_labels):
        ...
        """
        node_embeddings = self.compute_embeddings(g, device, val_test_nodes)
