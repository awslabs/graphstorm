...
class GSgnnEmbGenInferer(GSInferrer):
    ...
    def infer(self, data, infer_ntypes, save_embed_path, eval_fanout,
        ...
        infer_ntypes : list of str
            List of node types to compute embeddings for.
        save_embed_path : str
            The path where the GNN embeddings will be saved.
        eval_fanout: list of int
            The fanout of each GNN layer used in evaluation and inference.
        ...
        save_embed_format : str
            Specify the format of saved embeddings. Currently only "pytorch" is supported.
